...
class SpiritViewController: UIViewController {
    ...
    private func fetchData() {
        var count = 1
        let url = "https://api.nasa.gov/mars-photos/api/v1/rovers/spirit/photos?sol=1000&api_key=rmP0hLeNFBj9YHOSHrwhMhiltltjdDZDgolcA1Bf&page=\(count)"
...
extension SpiritViewController : UISearchBarDelegate {
